                ...
                <div className="col-lg-12 restaurent-meal-head mb-md-40">
                        ...
                        <div className="card-header">
                            <div className="section-header-left">
                                <h3 className="text-light-black header-title">
                                    <Link className="card-link text-light-black no-margin" to="#" onClick={() => this.setState({ open: !open })}
                    ...
                    <div className="card">
                        <div className="card-header">
                            <div className="section-header-left">
                                <h3 className="text-light-black header-title">
                                    <Link className="card-link text-light-black no-margin" to="#" onClick={() => this.setState({ open2: !open2 })}
